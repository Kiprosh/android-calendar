...
public class IntentKeys {
    ...
    public static final String KEY_START_TIME_MILLIS = "START_TIME_MILLIS";
    public static final String KEY_END_TIME_MILLIS = "END_TIME_MILLIS";
    public static final String KEY_ATTENDEE_RESPONSE = "ATTENDEE_RESPONSE";
